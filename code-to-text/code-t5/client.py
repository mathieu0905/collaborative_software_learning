...
class CustomFedAvg(fl.server.strategy.FedAvg):
    def aggregate_evaluate(
        ...
        print(f"Round {server_round+args.checkpoint_round} eval_ppl aggregated from client results: {aggregated_eval_ppl}")
...
fl.simulation.start_simulation(
    ...
    config=fl.server.ServerConfig(num_rounds=10-args.checkpoint_round),
