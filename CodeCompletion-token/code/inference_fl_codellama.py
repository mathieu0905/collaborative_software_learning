...
def main():
    ...
    tokenizer = tokenizer_class.from_pretrained(model_name_or_path, do_lower_case=args.do_lower_case, sep_token='<EOL>', bos_token='<s>', eos_token='</s>', pad_token='<pad>', unk_token='<|UNKNOWN|>', additional_special_tokens=special_tokens, cache_dir="/data/model")
    ...
    adapter = torch.load(f"{pretrained}/adapter_model.bin")
